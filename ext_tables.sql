...
CREATE TABLE tx_fcseminars_domain_model_fcseminars (
	...
	steckbrief varchar(255) DEFAULT '' NOT NULL,
	mehr varchar(255) DEFAULT '' NOT NULL,
	zusatzfeld1 varchar(255) DEFAULT '' NOT NULL,
	zusatzfeld2 text NOT NULL,
	zusatzfeld3 varchar(255) DEFAULT '' NOT NULL,
